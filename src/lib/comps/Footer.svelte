...
//           <p className = "text-gray-400">We are a lab committed to getting students active in design. </p>
//         </div>
...
//               <Link className = "hover:text-primary-50 text-gray-400" style={{textDecoration: 'none' }} href="/getting_started">
//                 Getting Started
//               </Link>
//             </li>
//             <li style={{ marginBottom: '5px'}}>
//             <Link className = "hover:text-primary-50 text-gray-400" style={{textDecoration: 'none' }} href="/Leadership">
//                 Leadership
//               </Link>
//             </li>
//           </ul>
